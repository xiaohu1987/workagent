...
function makeConfig(): AppConfig {
  return {
    ...
    desktop: { theme: "system", approvals: "prompt", browserOpenMode: "in_app", silentBrowserOpen: true, liveEditPreview: true, llmLogViewer: false, autoTitleGeneration: true, completionAudit: { project: { enabled: true, maxAttempts: 3 }, chat: { enabled: true, maxAttempts: 3 } }, sandboxMode: "read-only", sandboxNetworkAccess: false },
