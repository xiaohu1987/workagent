...
declare global {
  interface Window {
    codexh: {
      ...
      listQuickNotes: () => Promise<Array<{ id: string; title: string; content: string; knowledgeBaseId: string; knowledgeSourcePath: string; createdAt: string; updatedAt: string; cloudNoteId: string | null }>>;
      ...
      configureCloudNotes: (payload: { serverUrl?: string; email?: string; displayName?: string; deviceId?: string }) => Promise<{
        configured: boolean;
        serverUrl: string;
        email: string;
        displayName: string;
      ...
      loginCloudNotes: (payload: { password: string; register?: boolean }) => Promise<{
        configured: boolean;
        serverUrl: string;
        email: string;
        displayName: string;
      ...
      logoutCloudNotes: () => Promise<void>;
      syncCloudNotes: () => Promise<{
        pulled: number;
        pushed: number;
        conflicts: number;
        cursor: number;
      ...
      listCloudNotes: () => Promise<Array<{ id: string; title: string; content: string; version: number; seq: number; deleted: boolean; dirty: boolean; serverUpdatedAt: string | null; createdAt: string; updatedAt: string }>>;
      saveCloudNote: (payload: { id?: string; title?: string; content: string; dirty?: boolean }) => Promise<{ id: string; title: string; content: string; version: number; seq: number; deleted: boolean; dirty: boolean; serverUpdatedAt: string | null; createdAt: string; updatedAt: string }>;
      deleteCloudNote: (id: string) => Promise<void>;
      listCloudNoteLinks: () => Promise<Array<{ cloudNoteId: string; quickNoteId: string; createdAt: string; updatedAt: string }>>;
      pullCloudNoteToQuickNote: (cloudNoteId: string) => Promise<{ cloudNoteId: string; quickNoteId: string }>;
      syncQuickNoteToCloud: (quickNoteId: string) => Promise<{ cloudNoteId: string; synced: boolean; message: string }>;
