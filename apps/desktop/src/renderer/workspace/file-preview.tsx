...
import { getFilePreviewLanguage, highlightFilePreview, type PreviewCacheEntry } from "./file-preview-utils";

export type { PreviewCacheEntry } from "./file-preview-utils";
