...
const api = {
  ...
  getCloudNotesStatus: () => ipcRenderer.invoke("cloud-notes:status"),
  configureCloudNotes: (payload: { serverUrl?: string; email?: string; displayName?: string; deviceId?: string }) => ipcRenderer.invoke("cloud-notes:configure", payload),
  loginCloudNotes: (payload: { password: string; register?: boolean }) => ipcRenderer.invoke("cloud-notes:login", payload),
  logoutCloudNotes: () => ipcRenderer.invoke("cloud-notes:logout"),
  syncCloudNotes: () => ipcRenderer.invoke("cloud-notes:sync"),
  listCloudNotes: () => ipcRenderer.invoke("cloud-notes:list"),
  saveCloudNote: (payload: { id?: string; title?: string; content: string; dirty?: boolean }) => ipcRenderer.invoke("cloud-notes:save", payload),
  deleteCloudNote: (id: string) => ipcRenderer.invoke("cloud-notes:delete", id),
  listCloudNoteLinks: () => ipcRenderer.invoke("cloud-notes:links"),
  pullCloudNoteToQuickNote: (cloudNoteId: string) => ipcRenderer.invoke("cloud-notes:pull-to-quick-note", cloudNoteId),
  syncQuickNoteToCloud: (quickNoteId: string) => ipcRenderer.invoke("cloud-notes:sync-quick-note", quickNoteId),
